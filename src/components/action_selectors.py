...
from .epsilon_schedules import DecayThenFlatSchedule, RODEDecayThenFlatSchedule
...
class SoftEpsilonGreedyActionSelector():
    ...
    def __init__(self, args):
        ...
        self.schedule = RODEDecayThenFlatSchedule(args.epsilon_start, args.epsilon_finish, args.epsilon_anneal_time,
